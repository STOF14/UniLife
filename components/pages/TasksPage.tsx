...
            </div>
            ...
            <h2 className="text-xl font-medium text-white mb-4">Upcoming Tasks ({tasksToPage.length})</h2>
...
            )}
            ...
            {completedTasks.length > 0 && (
                <div className="mt-8 pt-6 border-t border-[#38383A]">
                    <h2 className="text-xl font-medium text-white mb-4">Completed Tasks ({completedTasks.length})</h2>
                    <div className="space-y-2">
